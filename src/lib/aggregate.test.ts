...
describe('buildSeries', () => {
  it('월별 시계열', () => {
    ...
    expect(series).toEqual([
      { month: '2025-01', cash: 100, investment: 200, krw: 300, usd: 0, total: 300, income: 10, expense: 5, savings: 5 },
      { month: '2025-02', cash: 150, investment: 250, krw: 400, usd: 0, total: 400, income: 20, expense: 8, savings: 12 },
    ]);
  });
});
